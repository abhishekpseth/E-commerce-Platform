...
interface AddNewAddressModalPayload {
  setAddNewAddressModalOpen: (addNewAddressModalOpen : boolean) => void;
  fetchAllAddresses: () => void;
}

const AddNewAddressModal = ({setAddNewAddressModalOpen, fetchAllAddresses} : AddNewAddressModalPayload) : JSX.Element => {
  const showNotification = useNotification();
  const [saveAddressLoading, setSaveAddressLoading] = useState<boolean>(false);
