...
interface OrderItemCardPayload {
...
const OrderItemCard = ({ orderItem, showProductDetails, setShowProductDetails, selectedOrder, setSelectedOrder } : OrderItemCardPayload) : JSX.Element => {
  return (
