...
interface RiderOrderItemCardPayload {
  orderItem: RiderOrder | null;
  showProductDetails: boolean;
  setShowProductDetails: (showProductDetails : boolean) => void;
  selectedOrder: RiderOrder | null;
  setSelectedOrder: (selectedOrder : RiderOrder | null) => void;
  setIsOrderStatusModalOpen: (isOrderStatusModalOpen : boolean) => void;
}

const RiderOrderItemCard = ({ orderItem, showProductDetails, setShowProductDetails, selectedOrder, setSelectedOrder, setIsOrderStatusModalOpen } : RiderOrderItemCardPayload) : JSX.Element => {
  return (
