...
interface WishlistedItemCardPayload {
  wishlistedItem: WishlistItem;
  getWishlist: () => void;
  setSelectedWishlistedItem: (wishlistItem: WishlistItem | null) => void
}

const WishlistedItemCard = ({ wishlistedItem, getWishlist, setSelectedWishlistedItem } : WishlistedItemCardPayload) : JSX.Element => {
