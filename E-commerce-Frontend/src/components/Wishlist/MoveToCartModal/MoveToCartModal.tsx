...
interface MoveToCartModalPayload {
  selectedWishlistedItem: WishlistItem;
  setSelectedWishlistedItem: (wishlistItem: WishlistItem | null) => void;
  getWishlist: () => void;
}

const MoveToCartModal = ({ selectedWishlistedItem, setSelectedWishlistedItem, getWishlist } : MoveToCartModalPayload) : JSX.Element => {
