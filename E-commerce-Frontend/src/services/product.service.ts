...
const fetchAll = async (userID: string | null, searchInput: string, selectedColors: string[], selectedSizes: string[], selectedSortingOptionID: string, page: number, limit: number) => {
  try {
    const endPoint = "/";
